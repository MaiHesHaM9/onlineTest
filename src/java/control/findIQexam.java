 ...
 * @author go
 */
@WebServlet(name = "findIQexam", urlPatterns = {"/findIQexam"})
public class findIQexam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ArrayList<examWithScore>ids= x.getIdAndScore(4);
           ...
           rd.forward(request, response);
            ...
            Logger.getLogger(findIQexam.class.getName()).log(Level.SEVERE, null, ex);
