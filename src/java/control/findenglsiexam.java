 ...
 * @author go
 */
@WebServlet(name = "findenglsiexam", urlPatterns = {"/findenglsiexam"})
public class findenglsiexam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ArrayList<examWithScore>ids= x.getIdAndScore(3);
           ...
           request.setAttribute("ex","english");
           ...
           rd.forward(request, response);
            ...
            Logger.getLogger(findenglsiexam.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
