 ...
 * @author go
 */
@WebServlet(name = "findpythonexam", urlPatterns = {"/findpythonexam"})
public class findpythonexam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ArrayList<examWithScore>ids= x.getIdAndScore(1);
           ...
           request.setAttribute("ex","Python");
           ...
           rd.forward(request, response);
            ...
            Logger.getLogger(findpythonexam.class.getName()).log(Level.SEVERE, null, ex);
